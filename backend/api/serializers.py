...
from course.models import Course, Level, Links, Modul, Pract, Skill, Theme, UserCourse, UserLevel
...
class UserLevelSerializer(serializers.ModelSerializer):
	...
	def update(self, instance, validated_data):
		...
		instance.level_id.profession = level_data.get("profession", instance.level_id.profession)
		instance.level_id.level = level_data.get("level", instance.level_id.level)
...
class CourseSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Course
		fields = ("id", "title", "description", "price", "modul_id", "level_id")
