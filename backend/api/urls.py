...
urlpatterns = [
	...
	path("v1/docs/swagger_tracker.yaml", schema_view.without_ui(cache_timeout=0), name="schema-json"),
	path("v1/docs/swagger/", schema_view.with_ui("swagger", cache_timeout=0), name="schema-swagger-ui"),
	path("v1/docs/redoc/", schema_view.with_ui("redoc", cache_timeout=0), name="schema-redoc"),
]
